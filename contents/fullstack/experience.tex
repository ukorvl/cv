  ...
  \cventry
    ...
    {Sent. 2025 - Current} % Date(s)
    {
      ...
      \vspace{8pt}
        ...
        \item {Owned end-to-end frontend delivery for Crypto/Spend Card and Ledger Spend integration users (eligibility, onboarding, KYC handoff, card issuance, top-ups, limits, transaction history, balance, visuals, mocking flows).}
