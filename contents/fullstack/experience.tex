  ...
  \cventry
    ...
    {Sept. 2025 - Current} % Date(s)
    {
      ...
      \vspace{8pt}
        ...
        \item {Delivered end-to-end frontend flows for Spend Card and Ledger Spend users, including Apple Pay and Google Pay integration, eligibility checks, multi-level KYC flows, Sumsub integration, card issuance, top-ups, limits, transaction history, balance states, and UI mocks.}
