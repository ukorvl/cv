...
%---------------------------------------------------------
  \cventry
    ...
    {Sept. 2025 - Current} % Date(s)
    {
      ...
      \vspace{8pt}
        \item {Owned and maintained the Mastercard Crypto Credentials frontend, enabling smoother wallet connections, message/transaction signing, and critical user flows. Led migration from Web3Modal to Reown AppKit.}
        ...
        \item {Shipped and maintained multiple partner wallet integrations (Ledger, MetaMask, TrustWallet, and others) for the widget (React + Redux), including white-label embedding, theming, config-driven feature flags, localization, and iframe message communication.}
        \item {Implemented Playwright E2E and Vitest unit coverage for high-risk flows (on/off-ramp, KYC redirects, approvals/signatures, card onboarding).}
        \item {Integrated Web3 flows into UX: WalletConnect/Reown AppKit connection, multiple EVM chain support, message/transaction signing, and safe error/retry states across wallets.}
    ...
    {Aug. 2025 - Mar. 2026} % Date(s)
    {
      ...
      \vspace{8pt}
       \item {Designed architecture and built a Next.js + TypeScript frontend dApp from scratch, including wallet connection, on-chain interactions, and user flows for lenders and borrowers. Integrated Sentry, logging, and event analytics to monitor the product.}
        ...
        \item {Implemented AI infrastructure for the repository, writing clear rules for agents and creating agents for various purposes.}
      \end{cvitems}
    }
    {\vspace{16pt}}
