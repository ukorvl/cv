  ...
  \cventry
    ...
    {Sept. 2025 - Current} % Date(s)
    {
      ...
      \vspace{8pt}
        ...
        \item {Delivered end-to-end frontend flows for Spend Card and Ledger Spend users: eligibility checks, multi-level KYC flows, Sumsub instegration, card issuance, top-ups, limits, transaction history, balance states, and UI mocks.}
        ...
        \item {Shaped frontend architecture with FSD-inspired module boundaries, separation of concerns, dependency flow rules, and code quality gates to keep a large white-label codebase maintainable. Contributeв to frontend engineering standards, reusable component systems, and scalable development practices across the team.}
