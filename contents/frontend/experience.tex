  ...
  \cventry
    ...
    {Sept. 2020 - Mar. 2021} % Date(s)
    {
      ...
      \vspace{8pt}
        ...
        \item {Worked on a large financial analytics React application with a Python backend, where I created new UI elements, optimized loading time, and implemented advanced search across multiple sources.}
      \end{cvitems}
    }
    {\vspace{24pt}}
